...
<form name="form1" method="post" action="chkadmin.php" onSubmit="return chkinput(this)">
  <table width="558" height="405"  background="images/di.jpg" border="0" align="center" cellpadding="0" cellspacing="0" id="__01">
	<tr>
		<td width="194" >&nbsp;</td>
		<td width="364" ><table border="0" align="center" cellpadding="0" cellspacing="0">
		  ...
		  <tr>
		    <td height="126" align="center"><input name="imageField" type="image" src="images/newlogin_07.jpg" border="0" /></td>
		    <td align="center">&nbsp;</td>
		    <td align="center"><input type="reset" name="del" id="del" value="重填" />&nbsp;</td>
	      </tr>
	    </table></td>
	</tr>
	<tr>
